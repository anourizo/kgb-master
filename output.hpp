...
//   T00_kgb       pointer to allocated field
//   T0i_kgb       pointer to allocated field
//   Tij_kgb       pointer to allocated field
...
void writeSnapshots(metadata & sim, cosmology & cosmo, const double fourpiG, const double a, const double dtau_old, const int done_hij, const int snapcount, string h5filename,
  ...
  #endif
 Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_cdm, Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_b, Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_ncdm, Field<Real> * phi, Field<Real> * pi_k, Field<Real> * zeta, Field<Real> * chi, Field<Real> * Bi, Field<Real> * T00_kgb, Field<Real> * T0i_kgb, Field<Real> * Tij_kgb, Field<Real> * source, Field<Real> * Sij, Field<Cplx> * scalarFT, Field<Cplx> * BiFT, Field<Cplx> * SijFT, PlanFFT<Cplx> * plan_phi, PlanFFT<Cplx> * plan_chi, PlanFFT<Cplx> * plan_Bi, PlanFFT<Cplx> * plan_source, PlanFFT<Cplx> * plan_Sij
#ifdef CHECK_B
...
)
{
  ...
  if (sim.out_snapshot & MASK_T_KGB)
		T00_kgb->saveHDF5_server_open(h5filename + filename + "_T00_kgb");
...
if (sim.out_snapshot & MASK_T_KGB)
#ifdef EXTERNAL_IO
  T00_kgb->saveHDF5_server_write(NUMBER_OF_IO_FILES);
#else
  if (sim.downgrade_factor > 1)
    T00_kgb->saveHDF5_coarseGrain3D(h5filename + filename + "_T00_kgb.h5", sim.downgrade_factor);
  else
    T00_kgb->saveHDF5(h5filename + filename + "_T00_kgb.h5");
#endif
...
// if (sim.out_snapshot & MASK_T_KGB)
// {
// 	// COUT<<"output kgbsence energy"<<endl;
// 	#ifdef EXTERNAL_IO
// 			T00_kgb->saveHDF5_server_write(NUMBER_OF_IO_FILES);
// 			// T0i_kgb->saveHDF5_server_write(NUMBER_OF_IO_FILES);
// 			// Tij_kgb->saveHDF5_server_write(NUMBER_OF_IO_FILES);
// 	#else
// 			if (sim.downgrade_factor > 1)
// 			{
// 				T00_kgb->saveHDF5_coarseGrain3D(h5filename + filename + "_T00_kgb.h5", sim.downgrade_factor);
// 				// T0i_kgb->saveHDF5_coarseGrain3D(h5filename + filename + "_T0i_kgb.h5", sim.downgrade_factor);
// 				// Tij_kgb->saveHDF5_coarseGrain3D(h5filename + filename + "_Tij_kgb.h5", sim.downgrade_factor);
// 			}
// 			else
// 			{
// 				T00_kgb->saveHDF5(h5filename + filename + "_T00_kgb.h5");
// 				// T0i_kgb->saveHDF5(h5filename + filename + "_T0i_kgb.h5");
// 				// Tij_kgb->saveHDF5(h5filename + filename + "_Tij_kgb.h5");
// 			}
// 	#endif
// }
//kgb end
...
#endif
#endif
Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_cdm, Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_b, Particles_gevolution<part_simple,part_simple_info,part_simple_dataType> * pcls_ncdm, Field<Real> * phi, Field<Real> * pi_k ,Field<Real> * zeta, Field<Real> * chi, Field<Real> * Bi,  Field<Real> * T00_kgb, Field<Real> * T0i_kgb, Field<Real> * Tij_kgb, Field<Real> * source, Field<Real> * Sij, Field<Cplx> * scalarFT, Field<Cplx> * scalarFT_pi, Field<Cplx> * scalarFT_zeta, Field<Cplx> * BiFT, Field<Cplx> * T00_kgbFT, Field<Cplx> * T0i_kgbFT, Field<Cplx> * Tij_kgbFT, Field<Cplx> * SijFT, PlanFFT<Cplx> * plan_phi, PlanFFT<Cplx> * plan_pi_k , PlanFFT<Cplx> * plan_zeta, PlanFFT<Cplx> * plan_chi, PlanFFT<Cplx> * plan_Bi, PlanFFT<Cplx> * plan_T00_kgb, PlanFFT<Cplx> * plan_T0i_kgb, PlanFFT<Cplx> * plan_Tij_kgb, PlanFFT<Cplx> * plan_source, PlanFFT<Cplx> * plan_Sij
#ifdef CHECK_B
, Field<Real> * Bi_check, Field<Cplx> * BiFT_check, PlanFFT<Cplx> * plan_Bi_check
#endif
#ifdef VELOCITY
...
double H0 = Hconf(1., fourpiG,
    ...
    writePowerSpectrum(kbin, power, kscatter, pscatter, occupation, sim.numbins, sim.boxsize, (Real) numpts3d * (Real) numpts3d * 2. * M_PI * M_PI * (H0 * H0,  H0,  H0) , filename, "power spectrum of short wave correction (dimensionless)", a, sim.z_pk[pkcount]);
